...
$lrefrea = 'febi-bilstein-3';
?>
<title>Stand Sur mesure, Be Sirius, Réalisation de stand salon sur mesure</title>
...
<div id="imgactive">
<img src="img/FEBI BILSTEIN - EQUIP'AUTO 2013 (3)_gr.jpg" title="FEBI BILSTEIN - EQUIP'AUTO 2013 (3)" alt="FEBI BILSTEIN - EQUIP'AUTO 2013 (3)" />
</div>
<div id="txtactive">
<h1 class="titre">FEBI BILSTEIN</h1>
<p class="expo">Equip’Auto</p>
<p class="lieux">Paris Nord Villepinte</p>
<p class="surface">Partie Workshop 82.5 m&sup2;</p>
<p class="date">Octobre 2013</p>
<p class="type">Stand sur mesure</p>
<p class="description">
FEBI Bilstein disposait de 2 emplacements sur le salon Equip’Auto en Octobre 2013. Une partie Workshop d’une surface de 82.5 m&sup2;, sur mesure, réalisée par le standiste Be-Sirius.
</p>
</div>
<?php 
