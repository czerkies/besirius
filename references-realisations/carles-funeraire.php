...
<div id="imgactive">
	<a href="atm-plasturgie.php" title="ATM PLASTURGIE">
	<div id="fleche_g">
		<img src="previous.png" />
	</div>
	</a>
	<a href="cartridge-world.php" title="CARTRIDGE WORLD">
	<div id="fleche_d">
		<img src="next.png" />
	</div>
	</a>
<img src="img/CARLES FUNERAIRE - ART FUNERAIR_gr.jpg" title="CARLES FUNERAIRE - ART FUNERAIR" alt="CARLES FUNERAIRE - ART FUNERAIR" />
</div>
<div id="txtactive">
