...
<div id="imgactive">
	<a href="stradal.php" title="Stradal">
	<div id="fleche_g">
		<img src="previous.png" />
	</div>
	</a>
	<a href="acr-group.php" title="ACR GROUP">
	<div id="fleche_d">
		<img src="next.png" />
	</div>
	</a>
<img src="img/FMII BUSINESS IMMO - ESPACE CONFERENCE_gr.jpg" title="FMII BUSINESS IMMO - ESPACE CONFERENCE" alt="FMII BUSINESS IMMO - ESPACE CONFERENCE" />
</div>
<div id="txtactive">
