...
<div id="imgactive">
	<a href="q-park.php" title="QPARK">
	<div id="fleche_g">
		<img src="previous.png" />
	</div>
	</a>
	<a href="sfta-autodata.php" title="SFTA AUTODATA">
	<div id="fleche_d">
		<img src="next.png" />
	</div>
	</a>
<img src="img/SCHNEIDER ELECTRIQUE - RUNNING EXPO_gr.jpg" title="SCHNEIDER ELECTRIQUE - RUNNING EXPO" alt="SCHNEIDER ELECTRIQUE - RUNNING EXPO" />
</div>
<div id="txtactive">
