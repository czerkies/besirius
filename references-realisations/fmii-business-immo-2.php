...
<div id="imgactive">
<img src="img/FMII BUSINESS IMMO - REALISATION SALON_gr.jpg" title="FMII BUSINESS IMMO - REALISATION SALONE" alt="FMII BUSINESS IMMO - REALISATION SALON" />
</div>
<div id="txtactive">
<h1 class="titre">BUSINESS IMMO</h1>
<p class="expo">FMII</p>
<p class="lieux">Cnit La Défense</p>
<p class="surface">2000 m&sup2;</p>
<p class="date">Février 2014</p>
<p class="type">Réalisation complète d’un salon</p>
<p class="description">
Be-Sirius réalise des espaces de conférences sur vos salons, selon votre conception.
</p>
</div>
<?php 
