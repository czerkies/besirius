...
<div id="formulaire">
  <form method="post" action="">
    <input type="text" name="nom" value="<?php if(isset($_POST['nom'])) echo $_POST['nom']; ?>" title="Nom" placeholder="Nom" required><br>
    <input type="text" name="prenom" value="<?php if(isset($_POST['prenom'])) echo $_POST['prenom']; ?>" title="Prénom" placeholder="Prénom"><br>
    <input type="text" name="societe" value="<?php if(isset($_POST['societe'])) echo $_POST['societe']; ?>" title="Société" placeholder="Société"><br>
    <input type="email" name="email" value="<?php if(isset($_POST['email'])) echo $_POST['email']; ?>" title="Mail" placeholder="Mail" required><br>
    <input type="tel" name="telephone" value="<?php if(isset($_POST['telephone'])) echo $_POST['telephone']; ?>" title="Téléphone" placeholder="Téléphone"><br>
    ...
    <div id="contact2">
    <textarea class="radius" type="text" name="message" title="Descriptif de vos besoins" placeholder="Descriptif de vos besoins" required><?php if(isset($_POST['message'])) echo $_POST['message']; ?></textarea>
    <p>
      <input class="typo" type="reset" value="Vider">
      <input class="typo" type="submit" value="Envoyer">
    </p>
  </form>
</div>
<?php include('/homepages/1/d386199518/htdocs/ele/footer.php'); ?>
